...
ngBoxuppApp.factory('puppetModule',function($http,$q,$timeout,$routeParams){
	return{
		...
		downloadPuppetModule : function(fileUrl){
			alert(fileUrl);
			var filedata = {"fileURI" : fileUrl , "userID" : $routeParams.userID};
			var completeURL = "/boxupp/downloadPuppetModule";
			var deferred = $q.defer();
			$http({	
				method:'GET',
				headers:{'Content-Type':'application/json; charset=UTF-8'},
